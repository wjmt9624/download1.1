...
<div id="mainWrapper">
  ...
  <div id="content">
    ...
    <section id="jdk" class="page">
      <div class="productRow"><!-- Each product row contains info of 3 elements -->
        <article class="productInfo"><!-- Each individual product description -->
          <a href="${pageContext.request.contextPath}/download.action?download=software/jdk8u131x64.zip">jdk8u131x64</a><br/>
        </article>
      </div>
    </section>
      ...
      <form method="post" action="${pageContext.request.contextPath}/message.action">
        <center>
          <label id="label">
			...
			width:400px;
			margin:10px auto;
			display:inline-block;" placeholder="Your suggestion!" name="cust_message"><br/>
